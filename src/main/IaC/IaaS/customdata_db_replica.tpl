...
sudo mysql -v -e "CHANGE MASTER TO MASTER_HOST='%master_db_private_ip%', MASTER_PORT=3306, MASTER_USER='%mysql_replication_user%', MASTER_PASSWORD='%mysql_replication_password%';"
